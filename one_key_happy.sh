...
if [ -f ${plugin_file} ];then
    ...
    wget https://raw.githubusercontent.com/ibibicloud/Bt-Panel/master/plugin.json
    chattr +i /www/server/panel/data/plugin.json
else
    cd /www/server/panel/data
    wget https://raw.githubusercontent.com/ibibicloud/Bt-Panel/master/plugin.json
...
if [ -f ${repair_file} ];then
    ...
    cd /www/server/panel/data
    wget https://raw.githubusercontent.com/ibibicloud/Bt-Panel/master/repair.json
    chattr +i /www/server/panel/data/repair.json
else
    cd /www/server/panel/data
    wget https://raw.githubusercontent.com/ibibicloud/Bt-Panel/master/repair.json
